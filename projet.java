...
public class Projet{
		...
		do {
			...
			case 1 :
				...
				if (lectureClavier.next().charAt(0) == 'o')	
									// si l'utilisateur saisie la valeur 'o' alors 
									//il y'a ajout d'un compte épargne
                                   C.ajouteUnCompte("E") ;
				else      		
                                   C.ajouteUnCompte("A");  
			        break;
	...
	// fonction qui permet de saisir l'option
 ...
 // fonction qui permet de sortir du programme
 public static void sortir( ) {
	System.out.println("Au revoir et a bientot");
	System.exit(0) ; 
 }
 
 // fonction qui permet d'aider l'utilisateur
